...
class LoginViewModel : BaseViewModel() {
    ...
    fun loginUser(email: String, password: String, fcmToken: String, onResponse: ((TokenResponse?, String?) -> Unit)? = null) {
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val error = when(response.code()){
                            ...
                            403 -> AppManager.context.getString(R.string.cannot_login_to_this_account)
                            501 -> AppManager.context.getString(R.string.email_or_password_error_message)
        ...
        ApiClientManager.babyCareApi.getUserInfo(UserInfoRequest(apiToken))
            .enqueue(object : Callback<UserInfoResponse> {
                ...
                override fun onFailure(call: Call<UserInfoResponse>, t: Throwable) {
                    debugLogInfo("onFailure: ${t.message}")
                    userInfoLiveData.value = null
                    errorResponse.value = ErrorResponse(t.message ?: "エラー")
                }
            })
    }
